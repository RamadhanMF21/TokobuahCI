			...
			<div class="container-fluid">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('Id') ? 'is-invalid':'' ?>"
                 type="text" name="customer_id" placeholder="Customer Id" />
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
                 type="text" name="name" placeholder="Nama customer" />
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input class="form-control <?php echo form_error('alamat') ? 'is-invalid':'' ?>"
                 type="text" name="address" placeholder="Alamat customer" />
                <div class="invalid-feedback">
                  <?php echo form_error('almat') ?>
                </div>
              </div>
